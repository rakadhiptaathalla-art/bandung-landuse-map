...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [778168.034403, 9228093.961180, 811705.927693, 9243901.791728], maxZoom: 28, minZoom: 1, projection: new ol.proj.Projection({
            code: 'EPSG:32748',
...
map.getView().fit([778168.034403, 9228093.961180, 811705.927693, 9243901.791728], map.getSize());
...
var searchLayer = new SearchLayer({
    layer: lyr_AdministrasiKotaBandung_1,
    colName: 'NAMOBJ',
    zoom: 10,
    collapsed: true,
    map: map,
